...
public class GoblinPotActions : MonoBehaviour
{
    ...
    void DoCushion(bool just)
    {
        ...
        if (just && fluid != null)
        {
            ...
            if (cushionJustRewind) fluid.BeginSpillEpoch(fluid.rewindDelay + cushionJustRewindSeconds + 1.2f);
        ...
        if (fluid != null)
        {
            ...
            if (just && cushionJustRewind) need = Mathf.Max(need, fluid.rewindDelay + cushionJustRewindSeconds + 1.2f);

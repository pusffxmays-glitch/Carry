...
public class PotionGaugeUI : MonoBehaviour
{
    ...
    [Header("Layout")]
    public Vector2 barSize = new Vector2(34f, 260f);
    public Vector2 screenEdgeOffset = new Vector2(30f, 0f);
    [Tooltip("Anchor to the left edge of the screen (unchecked = right edge).")]
    ...
    void BuildUI()
    {
        ...
        Vector2 anchor = anchorLeft ? new Vector2(0f, 0.5f) : new Vector2(1f, 0.5f);
